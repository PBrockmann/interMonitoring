...
fwrite($fh, $cmd."\n");
$cmd='let colors={"3B63E6", "FF4500", "FFE000", "34D314", "FF1392", "FFA400", "775BB4", "F5E6BD", "789BF1", "AFDFE6", "0000C7", "1FB1AA", "B12121", "DEB886", "FFB6C1"}';
fwrite($fh, $cmd."\n");
$cmd="! Color for graticule";
fwrite($fh, $cmd."\n");
$cmd="ppl color 6, 80, 80, 80";
fwrite($fh, $cmd."\n");
$nd=1;
foreach ($_SESSION['simus'] as $s){
	$ncolor=$nd+6;     # Users colors will begin at 7
	$cmd="go set_color_from_hexa $ncolor `colors[i=$nd]`";
	fwrite($fh, $cmd."\n");
        $nd=$nd+1;
}
$cmd="\n!============================";
...
foreach ($_SESSION['simus'] as $s){
	$ncolor=$nd+6;     # Users colors will begin at 7
	$cmd="plot/nolab/over/color=$ncolor/line var[d=$nd]";
	fwrite($fh, $cmd."\n");
        $nd=$nd+1;
}
$cmd="\n!============================";
