...
$tmpfname = tempnam("tmp", "interMonitoring_".$_SESSION['script']."_");
unlink($tmpfname);
...
fwrite($fh, $cmd."\n");
$cmd=". /home/webservices/.env_fast_atlas.sh            # IPSL (webservices2017)";
fwrite($fh, $cmd."\n\n");
$cmd="#=====================================";
fwrite($fh, $cmd."\n");
$cmd="#### Please modify if needed";
...
fwrite($fh, $cmd."\n");
$cmd="        echo pyferret -batch \${outputdir}/\${file%%.nc}.png -script \${scriptname} \${file}";
fwrite($fh, $cmd."\n");
$cmd="        pyferret -batch \${outputdir}/\${file%%.nc}.png -script \${scriptname} \${file}";
fwrite($fh, $cmd."\n\n");
$cmd="        convert \${outputdir}/\${file%%.nc}.png \${outputdir}/\${file%%.nc}.gif";
fwrite($fh, $cmd."\n\n");
